...
export default function AuthPage() {
    ...
    const url = "https://f221ca5e-27cc-4552-8da5-7c88b2b75324-00-1wftuepvbx8fy.pike.replit.dev"
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (response.data && response.data.auth === true && response.data.token) {
                setAuthToken(response.data.token); // Save token to local storage
        ...
        <Row>
            ...
            <Col sm={6} className="p-4">
                ...
                <Col sm={5} className="d-grid gap-2">
                    ...
                    <p style={{ fontSize: "12px" }}>By signing up, you agree to the Terms of Service and Privacy Policy.</p>
                ...
                <Modal show={modalShow !== null} onHide={handleClose} animation={false} centered>
                    <Modal.Body>
                        <h2 className="mb-4" style={{ fontWeight: "bold" }}>{modalShow === "SignUp"
                            ? "Create your account"
